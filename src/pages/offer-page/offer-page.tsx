        ...
        <div className="offer__container container">
          <div className="offer__wrapper">
            ...
            <div className="offer__name-wrapper">
              <h1 className="offer__name"/>{selectedOffer.title}
              {selectedOffer.isFavorite && (
                <button className="offer__bookmark-button button" type="button">
                  <svg className="offer__bookmark-icon" width="31" height="33">
                    <use xlinkHref="#icon-bookmark"/>
                  </svg>
                  <span className="visually-hidden"/>To bookmarks
                </button>
              )}
            </div>
            <div className="offer__rating rating">
              ...
              <span className="offer__rating-value rating__value"/>{selectedOffer.rating}
            </div>
            <ul className="offer__features">
              <li className="offer__feature offer__feature--entire"/>{selectedOffer.type}
              <li className="offer__feature offer__feature--bedrooms"/>3 Bedrooms
              <li className="offer__feature offer__feature--adults"/> Max 4 adults
            </ul>
            <div className="offer__price">
              <b className="offer__price-value"/>&euro;{selectedOffer.price}
              <span className="offer__price-text"/>&nbsp;night
            </div>
            <OfferInside/>
            <OfferHost/>
